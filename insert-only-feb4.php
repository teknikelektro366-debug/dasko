...
// Insert data HANYA untuk tanggal 4 Februari 2026
...
echo "🚀 Insert data untuk tanggal $date (Tanggal 4 Februari 2026)\n";
echo str_repeat("=", 80) . "\n\n";
...
echo "   Tekan Ctrl+F5 untuk hard refresh (hapus cache browser)\n";
