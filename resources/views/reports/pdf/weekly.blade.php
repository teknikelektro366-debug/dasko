...
<head>
    ...
    <style>
        ...
        .summary-value { font-size: 18px; font-weight: bold; color: #10B981; margin-top: 5px; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        th { background: #10B981; color: white; padding: 10px; text-align: left; font-size: 11px; }
...
<body>
    ...
    <div class="summary">
        <h3 style="margin-top: 0;">Ringkasan Mingguan</h3>
    ...
    <table>
        ...
        <tbody>
            @foreach($summary['daily_data'] as $day)
            <tr>
                <td>{{ $day['day'] }}</td>
                <td>{{ $day['date'] }}</td>
                <td>{{ $day['records'] }}</td>
                <td>{{ $day['avg_people'] }}</td>
