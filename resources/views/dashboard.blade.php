...
<head>
    ...
    <title>Dashboard Manajemen Energi</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <!-- ===== Monitoring Section (dari Overview) ===== -->
        <section id="Kontrol">
            <div class="navbar"><i class="fas fa-building"></i> Ruang Dosen Prodi Teknik Elektro</div>
            <div class="subnav" id="waktuRealtime"><i class="fas fa-clock"></i> Memuat waktu...</div>
            ...
            <div class="sensor-section">
                ...
                <div class="sensor-grid">
                    <div class="card sensor-card">
                        ...
                        <div class="value" id="suhuValue">27 °C</div>
                    </div>
                    ...
                    <div class="card sensor-card">
                        ...
                        <div class="value" id="jumlahOrang">0</div>
                    </div>
